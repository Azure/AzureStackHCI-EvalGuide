...
* [**Part 3a** - Create your nested Azure Stack HCI nodes with the GUI](/steps/3a_AzSHCINodesGUI.md "Create your nested Azure Stack HCI nodes with the GUI")
* [**Part 3b** - Create your nested Azure Stack HCI nodes with PowerShell](/steps/3b_AzSHCINodesPS.md "Create your nested Azure Stack HCI nodes with PowerShell")
