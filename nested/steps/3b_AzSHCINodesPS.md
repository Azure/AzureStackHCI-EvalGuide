...
With the installation complete, you'll be prompted to change the password before logging in.  Enter a password and exit to command line. Once complete, you should be at the **SCONFIG** screen.  Minimize the VM Connect window.
