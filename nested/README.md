...
![Architecture diagram for Azure Stack HCI 20H2 nested in Azure](/archive/media/nested_virt_arch_ga.png "Architecture diagram for Azure Stack HCI 20H2 nested in Azure")
